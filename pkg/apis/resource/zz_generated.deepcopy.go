...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeTopologyInfo) DeepCopyInto(out *NodeTopologyInfo) {
	*out = *in
	if in.Resources != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeTopologyInfo.
func (in *NodeTopologyInfo) DeepCopy() *NodeTopologyInfo {
	if in == nil {
		return nil
	}
	out := new(NodeTopologyInfo)
	in.DeepCopyInto(out)
	return out
}
