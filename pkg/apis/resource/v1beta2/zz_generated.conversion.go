...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*resource.ResourceSliceSpec)(nil), (*resourcev1beta2.ResourceSliceSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1beta2_ResourceSliceList_To_resource_ResourceSliceList(in *resourcev1beta2.ResourceSliceList, out *resource.ResourceSliceList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]resource.ResourceSlice, len(*in))
		for i := range *in {
			if err := Convert_v1beta2_ResourceSlice_To_resource_ResourceSlice(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_resource_ResourceSliceList_To_v1beta2_ResourceSliceList(in *resource.ResourceSliceList, out *resourcev1beta2.ResourceSliceList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]resourcev1beta2.ResourceSlice, len(*in))
		for i := range *in {
			if err := Convert_resource_ResourceSlice_To_v1beta2_ResourceSlice(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
