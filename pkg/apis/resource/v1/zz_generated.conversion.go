...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*resourcev1.NodeTopologyInfo)(nil), (*resource.NodeTopologyInfo)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_NodeTopologyInfo_To_resource_NodeTopologyInfo(a.(*resourcev1.NodeTopologyInfo), b.(*resource.NodeTopologyInfo), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*resource.NodeTopologyInfo)(nil), (*resourcev1.NodeTopologyInfo)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_resource_NodeTopologyInfo_To_v1_NodeTopologyInfo(a.(*resource.NodeTopologyInfo), b.(*resourcev1.NodeTopologyInfo), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_NodeTopologyInfo_To_resource_NodeTopologyInfo(in *resourcev1.NodeTopologyInfo, out *resource.NodeTopologyInfo, s conversion.Scope) error {
	out.NodeID = int(in.NodeID)
	out.Resources = *(*map[string]int64)(unsafe.Pointer(&in.Resources))
	out.Properties = *(*map[string]string)(unsafe.Pointer(&in.Properties))
	return nil
}

// Convert_v1_NodeTopologyInfo_To_resource_NodeTopologyInfo is an autogenerated conversion function.
func Convert_v1_NodeTopologyInfo_To_resource_NodeTopologyInfo(in *resourcev1.NodeTopologyInfo, out *resource.NodeTopologyInfo, s conversion.Scope) error {
	return autoConvert_v1_NodeTopologyInfo_To_resource_NodeTopologyInfo(in, out, s)
}

func autoConvert_resource_NodeTopologyInfo_To_v1_NodeTopologyInfo(in *resource.NodeTopologyInfo, out *resourcev1.NodeTopologyInfo, s conversion.Scope) error {
	out.NodeID = int32(in.NodeID)
	out.Resources = *(*map[string]int64)(unsafe.Pointer(&in.Resources))
	out.Properties = *(*map[string]string)(unsafe.Pointer(&in.Properties))
	return nil
}

// Convert_resource_NodeTopologyInfo_To_v1_NodeTopologyInfo is an autogenerated conversion function.
func Convert_resource_NodeTopologyInfo_To_v1_NodeTopologyInfo(in *resource.NodeTopologyInfo, out *resourcev1.NodeTopologyInfo, s conversion.Scope) error {
	return autoConvert_resource_NodeTopologyInfo_To_v1_NodeTopologyInfo(in, out, s)
}
...
func autoConvert_v1_ResourceSliceList_To_resource_ResourceSliceList(in *resourcev1.ResourceSliceList, out *resource.ResourceSliceList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]resource.ResourceSlice, len(*in))
		for i := range *in {
			if err := Convert_v1_ResourceSlice_To_resource_ResourceSlice(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_resource_ResourceSliceList_To_v1_ResourceSliceList(in *resource.ResourceSliceList, out *resourcev1.ResourceSliceList, s conversion.Scope) error {
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]resourcev1.ResourceSlice, len(*in))
		for i := range *in {
			if err := Convert_resource_ResourceSlice_To_v1_ResourceSlice(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1_ResourceSliceSpec_To_resource_ResourceSliceSpec(in *resourcev1.ResourceSliceSpec, out *resource.ResourceSliceSpec, s conversion.Scope) error {
	...
	if in.NodeTopology != nil {
		...
		*out = new(resource.NodeTopologyInfo)
		if err := Convert_v1_NodeTopologyInfo_To_resource_NodeTopologyInfo(*in, *out, s); err != nil {
			return err
		}
	} else {
...
func autoConvert_resource_ResourceSliceSpec_To_v1_ResourceSliceSpec(in *resource.ResourceSliceSpec, out *resourcev1.ResourceSliceSpec, s conversion.Scope) error {
	...
	if in.NodeTopology != nil {
		...
		*out = new(resourcev1.NodeTopologyInfo)
		if err := Convert_resource_NodeTopologyInfo_To_v1_NodeTopologyInfo(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.NodeTopology = nil
