...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NodeTopologyInfo)(nil), (*v1.NodeTopologyInfo)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_NodeTopologyInfo_To_v1_NodeTopologyInfo(a.(*NodeTopologyInfo), b.(*v1.NodeTopologyInfo), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1.NodeTopologyInfo)(nil), (*NodeTopologyInfo)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_NodeTopologyInfo_To_api_NodeTopologyInfo(a.(*v1.NodeTopologyInfo), b.(*NodeTopologyInfo), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_api_NodeTopologyInfo_To_v1_NodeTopologyInfo(in *NodeTopologyInfo, out *v1.NodeTopologyInfo, s conversion.Scope) error {
...
// Convert_api_NodeTopologyInfo_To_v1_NodeTopologyInfo is an autogenerated conversion function.
func Convert_api_NodeTopologyInfo_To_v1_NodeTopologyInfo(in *NodeTopologyInfo, out *v1.NodeTopologyInfo, s conversion.Scope) error {
	return autoConvert_api_NodeTopologyInfo_To_v1_NodeTopologyInfo(in, out, s)
}

func autoConvert_v1_NodeTopologyInfo_To_api_NodeTopologyInfo(in *v1.NodeTopologyInfo, out *NodeTopologyInfo, s conversion.Scope) error {
	out.NodeID = in.NodeID
	out.Resources = *(*map[string]int64)(unsafe.Pointer(&in.Resources))
	out.Properties = *(*map[string]string)(unsafe.Pointer(&in.Properties))
	return nil
...
// Convert_v1_NodeTopologyInfo_To_api_NodeTopologyInfo is an autogenerated conversion function.
func Convert_v1_NodeTopologyInfo_To_api_NodeTopologyInfo(in *v1.NodeTopologyInfo, out *NodeTopologyInfo, s conversion.Scope) error {
	return autoConvert_v1_NodeTopologyInfo_To_api_NodeTopologyInfo(in, out, s)
}
...
func autoConvert_api_ResourceSliceSpec_To_v1_ResourceSliceSpec(in *ResourceSliceSpec, out *v1.ResourceSliceSpec, s conversion.Scope) error {
	...
	out.NodeTopology = (*v1.NodeTopologyInfo)(unsafe.Pointer(in.NodeTopology))
	return nil
}
...
func autoConvert_v1_ResourceSliceSpec_To_api_ResourceSliceSpec(in *v1.ResourceSliceSpec, out *ResourceSliceSpec, s conversion.Scope) error {
	...
	out.NodeTopology = (*NodeTopologyInfo)(unsafe.Pointer(in.NodeTopology))
	return nil
}
